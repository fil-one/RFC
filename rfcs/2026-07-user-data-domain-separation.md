...
These endpoints serve untrusted, user-controlled content: uploaded objects, presigned URLs, and (in future) potentially browsable/static content. This is a problem because domain reputation systems operate at _registrable domain_ granularity, not subdomain:
...
1. **Register a dedicated data domain** — adopted: `filonecontent.com`. Regional S3 endpoints become `s3.<region>.filonecontent.com` (e.g. `s3.eu-west-1.filonecontent.com`).
