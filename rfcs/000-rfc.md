...
Informational RFCs are published for the general information of the community, and do not represent consensus or recommendations for our team or community, nor any kind of (even potential) process or standard which could be followed. They are simply a statement of facts published to make information more broadly known. As in the IETF's guidelines, "[If it can't be practiced, it's Informational.](https://www.ietf.org/process/process/informational-vs-experimental/#:~:text=If%20it%20can%27t%20be%20practiced%2C%20it%27s%20Informational.)"
...
Best Practice RFCs document *existing* team processes and are intended to help our team and community members follow some common guidelines for policies and operations.
...
RFC documents MUST be markdown and MUST have a 3 digit numeric prefix, incremented by 1 each time a new RFC is proposed.
...
<!-- what this documents and why it's worth knowing -->
...
<!-- the normative MUST/SHOULD statements -->
...
It is the responsibility of the author to seek and gain quorum and merge the PR (or close it).
...
- **Best Practice**:
  - ✅: Confirmed as description of current best practice
...
- **Standard**: *(almost always a PR to promote an existing RFC from Proposed Standard to Standard)*
